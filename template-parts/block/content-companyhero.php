...
if ( ! empty( $block['style']['spacing']['padding']['top'] ) ) {
	$inline_styles .= 'padding-top:' . $block['style']['spacing']['padding']['top'] . ';';
}
if ( ! empty( $block['style']['spacing']['padding']['right'] ) ) {
	$inline_styles .= 'padding-right:' . $block['style']['spacing']['padding']['right'] . ';';
}
if ( ! empty( $block['style']['spacing']['padding']['bottom'] ) ) {
	$inline_styles .= 'padding-bottom:' . $block['style']['spacing']['padding']['bottom'] . ';';
}
if ( ! empty( $block['style']['spacing']['padding']['left'] ) ) {
	$inline_styles .= 'padding-left:' . $block['style']['spacing']['padding']['left'] . ';';
}
if ( ! empty( $block['style']['spacing']['margin']['top'] ) ) {
	$inline_styles .= 'margin-top:' . $block['style']['spacing']['margin']['bottom'] . ';';
}
if ( ! empty( $block['style']['spacing']['margin']['bottom'] ) ) {
	$inline_styles .= 'margin-bottom:' . $block['style']['spacing']['margin']['bottom'] . ';';
}


?>

<header <?php echo esc_attr( $anchor ); ?> class="roboCom-hero <?php echo esc_attr( $classes ); ?>" style="<?php echo esc_attr( $inline_styles ); ?>">
	<div class="txtArea">
		<?php
		global $post;
	...
	<div class="imgArea">
		...
		if ( ! empty( $hero_image ) ) :
			...
			$image_url       = wp_get_attachment_image_src( $hero_image_id, $hero_image_size );
